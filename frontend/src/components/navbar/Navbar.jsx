  ...
  return (
    <div className="bg-white sticky top-0 z-50">
            ...
            >
              ...
              >
                <div className="flex px-4 pb-2 pt-28">
                  <button
                    type="button"
                    className="-m-2 inline-flex items-center justify-center rounded-md p-2 text-green-400"
                ...
                <div className="space-y-6 border-t border-green-200 px-4 py-6">
                  <Link
                    to={"/allproducts"}
                  ...
                  <div className="flow-root">
                    ...
                    >
                      <img
                        ...
                        src="https://p1.hiclipart.com/preview/555/632/34/person-user-avatar-user-profile-system-green-plant-symbol-png-clipart.jpg"
                        alt="User"
                      />{" "}
                    </Link>
                  </div>
      ...
      <header className="relative bg-white">
        ...
        <nav
          aria-label="Top"
          className="bg-green-100 px-4 sm:px-6 lg:px-8 shadow-xl "
          style={{
        ...
        >
          <div className="">
            <div className="flex h-16 items-center">
              <button
                type="button"
                className="rounded-md bg-white p-2 text-green-400 lg:hidden"
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  >
                    ...
                    <span
                      className="ml-2 text-sm font-medium text-green-700 group-"
                      style={{ color: mode === "dark" ? "white" : "" }}
                    >
                      {cartItems.length}
                    </span>
