...
function AddProduct() {
  ...
  const addProduct = async () => {
    ...
    const res = await newProduct({
      ...
      products: {
        name,
        stock,
        price: productDetails[name].price,
        category: productDetails[name].category,
        descritption: productDetails[name].description
      }
    });
  ...
  return (
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="relative py-2">
                  <button onClick={addProduct} class="before:ease relative h-12 w-40 overflow-hidden border border-green-500 bg-green-500 text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-green-500 hover:before:-translate-x-40">
    ...
    //           }
    //           name="title"
    //           className=" bg-green-600 mb-4 px-2 py-2  rounded-lg text-white placeholder:text-green-200 outline-none"
    //           placeholder="Product name"
    //         />
    //         {showSuggestions && (
    //           <ul className="absolute z-10 w-full border border-gray-300 rounded-md bg-white shadow-md">
    //             {productList
    //               .filter((suggestion) =>
    //                 suggestion.toLowerCase().includes(name.toLowerCase())
    //               )
